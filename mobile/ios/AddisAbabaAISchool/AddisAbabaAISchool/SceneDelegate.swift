...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        // Resume AI services when app becomes active
        resumeAIServices()
    }
    ...
    func sceneWillResignActive(_ scene: UIScene) {
        ...
        // Pause AI services when app becomes inactive
        pauseAIServices()
    }
    ...
    private func resumeAIServices() {
        // Resume AI services when app becomes active
        print("Resuming AI services")
    }
    
    private func pauseAIServices() {
        // Pause AI services when app becomes inactive
        print("Pausing AI services")
    }
